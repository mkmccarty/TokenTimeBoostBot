...
var AllLeaderboards = []LBDef{
	...
	{Key: LBSoulMirrors, DisplayName: "Soul Mirrors", HeaderName: "SM", Description: "Rank based on soul mirror inventory of Common, Epic & Legendary worth 1, 2, or 3 points respectively.", ValueFmt: "int", HigherIsBetter: false, Source: SourceFirstContact},
