...
var ArtifactMap = map[string]*Artifact{
	...
	"CH-T4L":    {Type: "Chalice", Quality: "T4L", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 3},
	"CH-T4E":    {Type: "Chalice", Quality: "T4E", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 2},
	"CH-T4C":    {Type: "Chalice", Quality: "T4C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"CH-T3E":    {Type: "Chalice", Quality: "T3E", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 2},
	"CH-T3R":    {Type: "Chalice", Quality: "T3R", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 1},
	"CH-T3C":    {Type: "Chalice", Quality: "T3C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"CH-T2E":    {Type: "Chalice", Quality: "T2E", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 2},
	"CH-T2C":    {Type: "Chalice", Quality: "T2C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"CH-T1C":    {Type: "Chalice", Quality: "T1C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"CH-NONE":   {Type: "Chalice", Quality: "NONE", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"ID-T4L":    {Type: "IHR Deflector", Quality: "T4L", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 2},
	"ID-T4E":    {Type: "IHR Deflector", Quality: "T4E", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 2},
	"ID-T4R":    {Type: "IHR Deflector", Quality: "T4R", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 1},
	"ID-T4C":    {Type: "IHR Deflector", Quality: "T4C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"ID-T3R":    {Type: "IHR Deflector", Quality: "T3R", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 1},
	"ID-T3C":    {Type: "IHR Deflector", Quality: "T3C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"ID-NONE":   {Type: "IHR Deflector", Quality: "NONE", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"MO-T4L":    {Type: "Monocle", Quality: "T4L", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 3},
	"MO-T4E":    {Type: "Monocle", Quality: "T4E", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 2},
	"MO-T4C":    {Type: "Monocle", Quality: "T4C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"MO-T3C":    {Type: "Monocle", Quality: "T3C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"MO-T2C":    {Type: "Monocle", Quality: "T2C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"MO-T1C":    {Type: "Monocle", Quality: "T1C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"MO-NONE":   {Type: "Monocle", Quality: "NONE", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"SIAB-T4L":  {Type: "SIAB", Quality: "T4L", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 2},
	"SIAB-T4E":  {Type: "SIAB", Quality: "T4E", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 2},
	"SIAB-T4R":  {Type: "SIAB", Quality: "T4R", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 1},
	"SIAB-T4C":  {Type: "SIAB", Quality: "T4C", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 0},
	"SIAB-T3R":  {Type: "SIAB", Quality: "T3R", ShipBuff: 1.0, LayBuff: 1.0, DeflBuff: 1.0, Stones: 1},
...
// The returned map has keys "defl", "metr", "comp", "guss", "chalice", "monocle", "SIAB"
// with tier+rarity values like "T4L", "T3R", etc.
func GetBestCoopArtifactsFromInventory(items []*ArtifactInventoryItem) map[string]string {
	...
	targets := []struct {
		...
		{"chalice", ArtifactSpec_THE_CHALICE},
		{"monocle", ArtifactSpec_DILITHIUM_MONOCLE},
		{"SIAB", ArtifactSpec_SHIP_IN_A_BOTTLE},
	}
...
func PopulateColleggtiblesInArtifactMap() {
	...
	for key, art := range ArtifactMap {
		if art.Type == "Collegg" && key != "NONE" {
			delete(ArtifactMap, key)
		}
	}

	keys := make([]string, 0, len(CustomEggMap))
	for k := range CustomEggMap {
		keys = append(keys, k)
	}
	sort.Strings(keys)
	...
	for _, k := range keys {
		...
		name := strings.ToUpper(egg.Name)
		quality := ""
		if len(egg.DimensionValueString) > 0 {
			quality = egg.DimensionValueString[len(egg.DimensionValueString)-1]
		}
