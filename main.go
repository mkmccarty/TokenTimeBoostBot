...
func setupCommands() {
	commandRegistry = []CommandDef{
		...
		},
		{
			...
			Category:     CmdCategoryAdmin,
			Handler:      boost.HandleAdminGetContractData,
			Autocomplete: boost.HandleCoopAutoComplete,
		},
		{
		...
		},
		{
			...
			Category:     CmdCategoryStandard,
			Handler:      boost.HandleScoreExplorerCommand,
			Autocomplete: boost.HandleAllContractsAutoComplete,
		},
		{
		...
		},
		{
			...
			Category: CmdCategoryStandard,
			Handler:  boost.HandleCoopETACommand,
		},
		{
		...
		{
			AppCmd:       boost.GetSlashCalcContractTval(slashCalcContractTval),
			Category:     CmdCategoryStandard,
			Handler:      boost.HandleContractCalcContractTvalCommand,
			Autocomplete: boost.HandleAltsAutoComplete,
		},
		{
		...
		},
		{
			...
			Category:     CmdCategoryStandard,
			Handler:      boost.HandleTeamworkEvalCommand,
			Autocomplete: boost.HandleAllContractsAutoComplete,
		},
		{
		...
		},
		{
			...
			Category:     CmdCategoryStandard,
			Handler:      boost.HandleEstimateTimeCommand,
			Autocomplete: boost.HandleAllContractsAutoComplete,
		},
		{
			AppCmd:       boost.GetSlashCsEstimates(slashCsEstimate),
			Category:     CmdCategoryStandard,
			Handler:      boost.HandleCsEstimatesCommand,
			Autocomplete: boost.HandleAllContractsAutoComplete,
		},
		{
			AppCmd:       boost.GetSlashLobbyCommand(slashLobby),
			Category:     CmdCategoryStandard,
			Handler:      boost.HandleLobbyCommand,
			Autocomplete: boost.HandleAllContractsAutoComplete,
		},
		{
